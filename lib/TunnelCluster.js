...
module.exports = class TunnelCluster extends EventEmitter {
  ...
  open() {
    ...
    console.log(`Tunnel secure state: ${isTunnelSecure}`);
    const remote = isTunnelSecure ? tls.connect({...connectionOptions, servername: remoteHostOrIp}) : net.connect(connectionOptions);
